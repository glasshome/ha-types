...
import type { ServiceName, ServiceCall } from "./services";
...
export type WsCommandType = 'ai_task/preferences/get' | 'ai_task/preferences/set' | 'analytics' | 'analytics/preferences' | 'application_credentials/config' | 'application_credentials/config_entry' | 'assist_pipeline/device/capture' | 'assist_pipeline/device/list' | 'assist_pipeline/language/list' | 'assist_pipeline/pipeline_debug/get' | 'assist_pipeline/pipeline_debug/list' | 'assist_pipeline/run' | 'assist_satellite/get_configuration' | 'assist_satellite/intercept_wake_word' | 'assist_satellite/set_wake_words' | 'assist_satellite/test_connection' | 'auth/current_user' | 'auth/delete_all_refresh_tokens' | 'auth/delete_refresh_token' | 'auth/long_lived_access_token' | 'auth/refresh_token_set_expiry' | 'auth/refresh_tokens' | 'auth/sign_path' | 'backup/agents/info' | 'backup/can_decrypt_on_download' | 'backup/config/info' | 'backup/config/update' | 'backup/delete' | 'backup/details' | 'backup/end' | 'backup/generate' | 'backup/generate_with_automatic_settings' | 'backup/info' | 'backup/restore' | 'backup/start' | 'backup/subscribe_events' | 'blueprint/delete' | 'blueprint/import' | 'blueprint/list' | 'blueprint/save' | 'blueprint/substitute' | 'bluetooth/subscribe_advertisements' | 'bluetooth/subscribe_connection_allocations' | 'bluetooth/subscribe_scanner_details' | 'bluetooth/subscribe_scanner_state' | 'calendar/event/create' | 'calendar/event/delete' | 'calendar/event/update' | 'call_service' | 'camera/capabilities' | 'camera/get_prefs' | 'camera/stream' | 'camera/update_prefs' | 'camera/webrtc/candidate' | 'camera/webrtc/get_client_config' | 'camera/webrtc/offer' | 'cloud/cloudhook/create' | 'cloud/cloudhook/delete' | 'cloud/remove_data' | 'cloud/status' | 'cloud/subscription' | 'cloud/update_prefs' | 'cloud/webrtc/ice_servers' | 'condition_platforms/subscribe' | 'config/area_registry/create' | 'config/area_registry/delete' | 'config/area_registry/list' | 'config/area_registry/reorder' | 'config/area_registry/update' | 'config/auth/create' | 'config/auth/update' | 'config/auth_provider/homeassistant/admin_change_password' | 'config/auth_provider/homeassistant/admin_change_username' | 'config/auth_provider/homeassistant/change_password' | 'config/auth_provider/homeassistant/create' | 'config/auth_provider/homeassistant/delete' | 'config/category_registry/create' | 'config/category_registry/delete' | 'config/category_registry/list' | 'config/category_registry/update' | 'config/device_registry/list' | 'config/device_registry/update' | 'config/entity_registry/get' | 'config/entity_registry/get_automatic_entity_ids' | 'config/entity_registry/get_entries' | 'config/entity_registry/list' | 'config/entity_registry/list_for_display' | 'config/entity_registry/remove' | 'config/entity_registry/update' | 'config/floor_registry/create' | 'config/floor_registry/delete' | 'config/floor_registry/list' | 'config/floor_registry/reorder' | 'config/floor_registry/update' | 'config/label_registry/create' | 'config/label_registry/delete' | 'config/label_registry/list' | 'config/label_registry/update' | 'config_entries/get' | 'config_entries/subscribe' | 'conversation/agent/homeassistant/debug' | 'conversation/agent/homeassistant/language_scores' | 'conversation/agent/list' | 'conversation/chat_log/subscribe' | 'conversation/chat_log/subscribe_index' | 'conversation/process' | 'conversation/sentences/list' | 'device_automation/action/capabilities' | 'device_automation/action/list' | 'device_automation/condition/capabilities' | 'device_automation/condition/list' | 'device_automation/trigger/capabilities' | 'device_automation/trigger/list' | 'dhcp/subscribe_discovery' | 'diagnostics/get' | 'diagnostics/list' | 'dynalite/get-config' | 'dynalite/save-config' | 'energy/fossil_energy_consumption' | 'energy/get_prefs' | 'energy/info' | 'energy/save_prefs' | 'energy/solar_forecast' | 'energy/validate' | 'entity/source' | 'execute_script' | 'extract_from_target' | 'fire_event' | 'frontend/get_system_data' | 'frontend/get_user_data' | 'frontend/set_system_data' | 'frontend/set_user_data' | 'frontend/subscribe_system_data' | 'frontend/subscribe_user_data' | 'generic_camera/start_preview' | 'get_conditions_for_target' | 'get_config' | 'get_services' | 'get_services_for_target' | 'get_states' | 'get_triggers_for_target' | 'group/start_preview' | 'hardware/info' | 'hardware/subscribe_system_status' | 'hassio/update/config/info' | 'hassio/update/config/update' | 'history/history_during_period' | 'history/stream' | 'history_stats/start_preview' | 'homeassistant/expose_entity' | 'homeassistant/expose_entity/list' | 'homeassistant/expose_new_entities/get' | 'homeassistant/expose_new_entities/set' | 'integration/setup_info' | 'integration/wait' | 'knx/create_device' | 'knx/create_entity' | 'knx/delete_entity' | 'knx/get_base_data' | 'knx/get_entity_config' | 'knx/get_entity_entries' | 'knx/get_knx_project' | 'knx/get_schema' | 'knx/group_monitor_info' | 'knx/group_telegrams' | 'knx/project_file_process' | 'knx/project_file_remove' | 'knx/subscribe_telegrams' | 'knx/update_entity' | 'knx/validate_entity' | 'labs/list' | 'labs/update' | 'lcn/devices' | 'lcn/devices/add' | 'lcn/devices/delete' | 'lcn/devices/scan' | 'lcn/entities' | 'lcn/entities/add' | 'lcn/entities/delete' | 'logbook/event_stream' | 'logbook/get_events' | 'logger/integration_log_level' | 'logger/log_info' | 'logger/log_level' | 'manifest/get' | 'manifest/list' | 'media_player/browse_media' | 'media_player/search_media' | 'media_source/browse_media' | 'media_source/local_source/remove' | 'media_source/resolve_media' | 'mobile_app/push_notification_channel' | 'mobile_app/push_notification_confirm' | 'mold_indicator/start_preview' | 'mqtt/device/debug_info' | 'mqtt/subscribe' | 'network' | 'network/configure' | 'network/url' | 'number/device_class_convertible_units' | 'persistent_notification/get' | 'persistent_notification/subscribe' | 'ping' | 'recorder/adjust_sum_statistics' | 'recorder/change_statistics_unit' | 'recorder/clear_statistics' | 'recorder/get_statistics_metadata' | 'recorder/import_statistics' | 'recorder/info' | 'recorder/list_statistic_ids' | 'recorder/statistic_during_period' | 'recorder/statistics_during_period' | 'recorder/update_statistics_issues' | 'recorder/update_statistics_metadata' | 'recorder/validate_statistics' | 'render_template' | 'repairs/get_issue_data' | 'repairs/ignore_issue' | 'repairs/list_issues' | 'search/related' | 'sensor/device_class_convertible_units' | 'sensor/numeric_device_classes' | 'shopping_list/items' | 'shopping_list/items/add' | 'shopping_list/items/clear' | 'shopping_list/items/remove' | 'shopping_list/items/reorder' | 'shopping_list/items/update' | 'ssdp/subscribe_discovery' | 'statistics/start_preview' | 'subscribe_bootstrap_integrations' | 'subscribe_entities' | 'subscribe_events' | 'subscribe_trigger' | 'supported_features' | 'system_health/info' | 'system_log/list' | 'template/start_preview' | 'test_condition' | 'thread/add_dataset_tlv' | 'thread/delete_dataset' | 'thread/discover_routers' | 'thread/get_dataset_tlv' | 'thread/list_datasets' | 'thread/set_preferred_border_agent' | 'thread/set_preferred_dataset' | 'threshold/start_preview' | 'time_date/start_preview' | 'todo/item/list' | 'todo/item/move' | 'todo/item/subscribe' | 'trace/contexts' | 'trace/debug/breakpoint/clear' | 'trace/debug/breakpoint/list' | 'trace/debug/breakpoint/set' | 'trace/debug/breakpoint/subscribe' | 'trace/debug/continue' | 'trace/debug/step' | 'trace/debug/stop' | 'trace/get' | 'trace/list' | 'trigger_platforms/subscribe' | 'unsubscribe_events' | 'update/release_notes' | 'usb/scan' | 'validate_config' | 'weather/convertible_units' | 'weather/subscribe_forecast' | 'webhook/handle' | 'wyoming/info' | 'zeroconf/subscribe_discovery' | 'zha/devices/permit';
// ============================================
...
/** ``` */
export type CommandRequest<T extends WsCommandType> = T extends keyof Commands ? Commands[T] : never;
