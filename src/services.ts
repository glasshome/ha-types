...
export type AlarmControlPanelService =
  | "alarm_arm_away"
...
export type BangOlufsenService =
  | "beolink_allstandby"
  | "beolink_expand"
  | "beolink_join"
  | "beolink_leave"
...
export type HomeassistantService =
  | "check_config"
  | "reload_all"
  | "reload_config_entry"
  | "reload_core_config"
...
export type HomematicipCloudService =
...
export type InputSelectService =
  | "reload"
  | "select_first"
  | "select_last"
  | "select_next"
...
export type MicrosoftFaceService =
  | "create_group"
  | "create_person"
  | "delete_group"
  | "delete_person"
...
export type ModernFormsService =
...
export type MusicAssistantService =
  | "get_library"
  | "get_queue"
  | "play_announcement"
  | "play_media"
...
export type OpenthermGwService =
  | "reset_gateway"
...
export type RainmachineService =
  | "pause_watering"
...
export type ScreenlogicService =
  | "set_color_mode"
...
export type SystemBridgeService =
  | "get_process_by_id"
...
export type TransmissionService =
  | "add_torrent"
  | "remove_torrent"
  | "start_torrent"
  | "stop_torrent";
...
export type UnifiprotectService =
  | "add_doorbell_text"
...
export type WaterHeaterService =
  | "set_away_mode"
  | "set_operation_mode"
  | "set_temperature"
  | "turn_off"
...
/** }; */
/** ``` */
export type ServiceCall<D extends Domain, S extends ServiceName<D>> = D extends keyof Services
  ? S extends keyof Services[D]
    ? Services[D][S]
    : never
  : never;
